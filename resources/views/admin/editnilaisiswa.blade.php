	    	...
	    	<div class="table-cover">
	        	<div class="table-responsive">
              		...
              		<tr>
            			...
            			<tr>
            				<th>Aksi</th>
            				<td>: <button data-bs-toggle="modal" data-bs-target="#addDataList" class="btn btn-primary">Edit Dokumen Nilai</button></td>
            			</tr>
            			@if($count > 0)
            			<tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Dokumen Nilai</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body" style="margin-top: -5%;">
        <form action="{{ route('adddata.nilaisiswa') }}" method="post" enctype="multipart/form-data">
        	@csrf
        	<div>
        		<input type="hidden" name="id" value="{{ $siswa->id }}">
        	</div>
        	<div class="form-group mb-2">
        		<label><strong>Dokumen Hasil Studi</strong></label>
