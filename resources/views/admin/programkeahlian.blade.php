  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="margin-top: -5%;">
        <form action="{{ route('adddata.program') }}" method="post" enctype="multipart/form-data">
        	@csrf
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="edit-modal" style="margin-top: -5%;">
        <form action="{{ route('updatedata.program') }}" method="post" enctype="multipart/form-data">
        	@csrf
...
<script>
    ...
    $(function(){
    	$('#datatable').DataTable({
      		...
      		serverSide : true,
      		responsive : true,
      		ajax: "{{ route('programkeahlian.json') }}",
      		columns: [
        		{
